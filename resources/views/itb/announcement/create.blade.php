...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"> Tanlov qo'shish</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('announcement.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="ariza_begin" value="{{ old('ariza_begin') }}" id="deadline"> dan
                    <input type="date" name="ariza_end" value="{{ old('ariza_end') }}"> gacha
                </div>
                <div class="form-group">
                    <label for="sana" class="col-form-label">Tanlov sanasi:</label>
                    <input type="date" name="tanlov_begin" value="{{ old('tanlov_begin') }}" id="sana"> dan
                    <input type="date" name="tanlov_end" value="{{ old('tanlov_end') }}"> gacha
                </div>
                <div class="form-group">
